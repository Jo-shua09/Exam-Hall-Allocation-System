...
import { MapPin, Calendar, Clock, User, BookOpen, Hash, Printer, Download, RefreshCw, CheckCircle2, Building } from "lucide-react";
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          <div class="header">
            <h1>📚 Examination Hall Allocation</h1>
  ...
  return (
    <div className="animate-scale-in" ref={resultRef}>
      ...
      <div className="text-center mb-6">
        ...
        <h2 className="font-poppins font-bold text-2xl md:text-3xl text-foreground mb-2">Hall Found!</h2>
        <p className="text-muted-foreground">Your examination hall has been successfully located</p>
      </div>
      ...
      <div className="glass-card overflow-hidden">
        ...
        <div className="bg-hero-pattern p-8 text-center">
          ...
          <h3 className="font-poppins font-bold text-4xl md:text-5xl text-primary-foreground mb-2">{result.hall}</h3>
        </div>
        ...
        <div className="p-6 md:p-8 space-y-4">
          ...
          <div className="p-4 rounded-xl bg-primary/5 border border-primary/20 mt-4">
            <p className="text-sm text-primary font-medium">
              📌 Please arrive at least 30 minutes before your exam time. Bring your student ID and examination permit.
            </p>
          </div>
        </div>
